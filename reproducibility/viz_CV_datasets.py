...
# Open dict
with open('test_powers_compare.pkl', 'rb') as f:
...
O_errs = errors(O)
E1 = [E1_0_5_1_0, E1_1_5_1_0, E1_2_5_1_0, E1_3_5_1_0, E1_4_5_1_0, E1_5_5_1_0]
E1_errs = errors(E1)

plt.figure()
# Plot lines
plt.errorbar(x, F, F_errs, fmt='o-', color="#2a9d8f", markersize=2, label='F-test')
plt.errorbar(x, O, O_errs, fmt='o-', color='#808080', markersize=2, label='Oracle-test')
plt.errorbar(x, E1, E1_errs, fmt='o-', color="#000000", markersize=2, label='L-test')

plt.xlabel("Signal", fontsize=14)
plt.ylabel("Power", fontsize=14)
#plt.legend()
plt.yticks(np.arange(0, 1.1, step=0.2))
plt.savefig('compare/vary_sig_low_corr.png')
...
O_errs = errors(O)
E1 = [E1_0_5_1_5, E1_1_5_1_5, E1_2_5_1_5, E1_3_5_1_5, E1_4_5_1_5, E1_5_5_1_5]
E1_errs = errors(E1)
...
#plt.legend()
plt.yticks(np.arange(0, 1.1, step=0.2))
plt.savefig('compare/vary_sig_high_corr.png')
...
O_errs = errors(O)
E1 = [E1_1_0_1_0, E1_1_1_1_0, E1_1_2_1_0, E1_1_3_1_0, E1_1_4_1_0, E1_1_5_1_0]
E1_errs = errors(E1)
...
#plt.legend()
plt.yticks(np.arange(0, 1.1, step=0.2))
plt.savefig('compare/vary_spars1_low_sig.png')
...
O_errs = errors(O)
E1 = [E1_3_0_1_0, E1_3_1_1_0, E1_3_2_1_0, E1_3_3_1_0, E1_3_4_1_0, E1_3_5_1_0]
E1_errs = errors(E1)
...
#plt.legend()
plt.yticks(np.arange(0, 1.1, step=0.2))
plt.savefig('compare/vary_spars1_high_sig.png')
...
O_errs = errors(O)
E1 = [E1_1_2_0_0, E1_1_2_1_0, E1_1_2_2_0, E1_1_2_3_0, E1_1_2_4_0, E1_1_2_5_0]
E1_errs = errors(E1)
...
#plt.legend()
plt.yticks(np.arange(0, 1.1, step=0.2))
plt.savefig('compare/vary_spars2_low_sig.png')
...
O_errs = errors(O)
E1 = [E1_2_2_0_0, E1_2_2_1_0, E1_2_2_2_0, E1_2_2_3_0, E1_2_2_4_0, E1_2_2_5_0]
E1_errs = errors(E1)
...
#plt.legend()
plt.yticks(np.arange(0, 1.1, step=0.2))
plt.savefig('compare/vary_spars2_med_sig.png')
...
O_errs = errors(O)
E1 = [E1_3_2_0_0, E1_3_2_1_0, E1_3_2_2_0, E1_3_2_3_0, E1_3_2_4_0, E1_3_2_5_0]
E1_errs = errors(E1)
...
#plt.legend()
plt.yticks(np.arange(0, 1.1, step=0.2))
plt.savefig('compare/vary_spars2_high_sig.png')
...
O_errs = errors(O)
E1 = [E1_2_2_1_0, E1_2_2_1_1, E1_2_2_1_2, E1_2_2_1_3, E1_2_2_1_4, E1_2_2_1_5]
E1_errs = errors(E1)
...
#plt.legend()
plt.yticks(np.arange(0, 1.1, step=0.2))
plt.savefig('compare/vary_corr.png')
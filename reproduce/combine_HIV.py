...
MCfree_disc = sum(sum(value[3]) for value in disc.values())
...
# MCfree_powers = [value[3] for value in powers.values()]

# x = np.arange(len(keys))
# bar_width = 0.2
# plt.figure(figsize=style.figsize)
# plt.bar(x - 1.5 * bar_width, F_powers, width=bar_width, label='F-test', color=style.color_for("F-test"))
# plt.bar(x - 0.5 * bar_width, glasso_powers, width=bar_width, label='gLASSO', color=style.color_for("gLASSO"))
# plt.bar(x + 0.5 * bar_width, L_powers, width=bar_width, label='L-test', color=style.color_for("L-test"))
# plt.bar(x + 1.5 * bar_width, MCfree_powers, width=bar_width, label='MC-free', color=style.color_for("MC-free"))

# plt.xlabel('Group size', fontsize=style.text_size)
# plt.ylabel('Power', fontsize=style.text_size)

# plt.xticks(x, keys, fontsize=style.number_size)
...
# plt.xlabel('Group size', fontsize=style.text_size)
# plt.ylabel('Frequency', fontsize=style.text_size)
...
at least a certain value (ensure to comment out code for prior figures to avoid duplicate names).
"""
...
# plt.figure(figsize=style.figsize)
# plt.plot(x, F_powers, marker='o', markersize=style.marker_size, label='F-test', color=style.color_for("F-test"))
# plt.plot(x, glasso_powers, marker='o', markersize=style.marker_size, label='gLASSO', color=style.color_for("gLASSO"))
# plt.plot(x, L_powers, marker='o', markersize=style.marker_size, label='L-test', color=style.color_for("L-test"))
